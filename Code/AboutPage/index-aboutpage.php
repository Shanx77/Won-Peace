    ...
    <div class="container">
      <div class="row">
        <div class="col-12">
          <nav class="main-nav">
            <!-- ***** Logo Start ***** -->
            <a href="/About Page/index-aboutpage.php" class="logo">
              <img src="assets/images/logo1r.png" alt="Chain App Dev">
            </a>
            <!-- ***** Logo End ***** -->
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
              ...
              <li>
                <div class="gradient-button"><a id="modal_trigger" href="http://localhost/Won-Peace-/Code/About%20Page/reg-login/loginhtml.php"><i
          ...
          <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    <div class="white-button first-button scroll-to-section">
                      <a> The first wealth is health</a>
                    </div>
                    <div class="white-button scroll-to-section">
                      <a> Life is a tragedy of nutrition</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-6">
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="assets/images/slider-dec1.png" alt="">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-3">
          <div class="service-item first-service">
            <div class="icon"></div>
            <h4>Custom Diet plan</h4>
            <p>You get to choose dishes according to your allergies and medical conditions</p>
        ...
        <div class="col-lg-3">
          <div class="service-item second-service">
            <div class="icon"></div>
            <h4>Nutrient Hack</h4>
            <p>We provide a good amount of Snacks high in nutrients! </p>
          </div>
        </div>
        <div class="col-lg-3">
      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="section-heading">
            ...
            <img src="assets/images/heading-line-dec.png" alt="">
            <p text-color = "black">We are students of RVITM, we made this website as a part of our DBMS project. The calorie count may not
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="box-item">
                <h4><a>Won Peace</a></h4>
                <p>Our Current project which is this Website is for</p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="box-item">
                <h4><a>Communication Skills</a></h4>
                <p>We excel at Presenting and Communicating! </p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="box-item">
